        ...
        .then ((data) => {
            if (data.status == 200){
                for (let redflag of data.data){
                    ...
                    action.innerHTML = '<a href="update.html"><button class="block update-item">Update location</button><a href="update.html"><button class="block update-item">Update comment</button></a><a href=""><button class="block remove-item"> Delete</button></a>'
