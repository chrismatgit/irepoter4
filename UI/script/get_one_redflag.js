document.getElementById('getall').addEventListener('submit', get_all_redflags)
        ...
        .then ((data) => {
            if (data.status == 200){
                for (let redflag of data.data){
                    ...
                    action.innerHTML = '<a href="update_redflag_location.html"><button class="block update-item">Update location</button><a href="update_comment _red_flag.html"><button class="block update-item">Update comment</button></a><a href="delete_redflag.html"><button class="block remove-item"> Delete</button></a>'
